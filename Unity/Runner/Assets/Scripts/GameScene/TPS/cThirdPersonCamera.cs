...
|*
|* Este codigo sale de  Invector
|*  - para acompaniar a Invector.vCharacterController
|*
|* Al crear una camara este deba tener:
|*  + Transform
|*  + Camera
|*  + AudioListener
|*  - cThirdPersonCamera
|*
\*--------------------------------------------------------------------*/
namespace TauriLand.Tps.Camera
{
    public class cThirdPersonCamera : MonoBehaviour
    {
        ...
        [Tooltip("Velocidad de Lerp entre estados de la camara")]
        public float smoothCameraRotation = 12f;
        [Tooltip("Quu capa/layyer sera eliminada/culled?")]
        public LayerMask cullingLayer = 1 << 0;
        [Tooltip("Para fines de depuracion, bloquee la camara detrás del personaje para alinear mejor los estados.")]
